function IconShape({ name }) {
  switch (name) {
    case 'shield':
      return <><path d="M12 3 5 6v5c0 4.6 2.7 8.2 7 10 4.3-1.8 7-5.4 7-10V6l-7-3Z"/><path d="m9 12 2 2 4-5"/></>
    case 'key':
      return <><circle cx="8" cy="15" r="4"/><path d="m11 12 8-8M16 7l2 2M14 9l2 2"/></>
    case 'mail':
